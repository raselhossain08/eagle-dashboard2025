...
import { WooCommerceAnalytics } from '@/types/analytics';
...
export function WooCommerceCard({ woocommerceAnalytics }: WooCommerceCardProps) {
    const storeItems = [
        {
            label: 'Products',
        ...
        {
            label: 'Orders (Period)',
            value: analyticsService.formatNumber(woocommerceAnalytics.orders_in_period),
            icon: ShoppingCart,
        },
        {
            label: 'Currency',
        ...
        <Card>
            ...
            <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                    ...
                    <Badge variant={woocommerceAnalytics.store_enabled ? "default" : "destructive"}>
