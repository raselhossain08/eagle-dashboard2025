...
import { User, Mail, MapPin, Phone, Calendar, ShoppingBag, CreditCard, Building } from 'lucide-react';
...
export function CustomerDetailsDialog({ customer, open, onOpenChange }: CustomerDetailsDialogProps) {
    ...
    const hasBillingAddress = !!(customer.billing_address.first_name || customer.billing_address.address_1);
                            ...
                            <div className="grid grid-cols-2 gap-4 p-4 border rounded-lg">
                                ...
                                {customer.billing_address.address_1 && (
                                    <div className="col-span-2">
                                        ...
                                        <p className="text-sm">{customer.billing_address.address_1}</p>
                                    </div>
                                )}
                                ...
                                {customer.billing_address.country && (
                                    <div>
                                        ...
                                        <p className="text-sm">{customer.billing_address.country}</p>
                                    </div>
                                )}
