          ...
          <TableBody>
            {customers.map((customer) => {
              ...
              const hasCompleteProfile =
                customerService.hasCompleteProfile(customer);
                  ...
                  <TableCell>
                    <div className="flex items-center gap-3">
                      <div className="shrink-0">
                        <div className="w-8 h-8 bg-linear-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-sm font-medium">
