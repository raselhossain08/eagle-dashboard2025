...
const TemplateCreationDialog: React.FC<TemplateCreationDialogProps> = ({
    ...
    const [keywords, setKeywords] = useState<string[]>(template?.metadata?.keywords || []);
            ...
            reader.onload = async (e) => {
                try {
                    ...
                    if (file.type === 'text/plain') {
                        ...
                        toast.info('PDF extraction requires backend processing. Using basic extraction...');
                        ...
                        toast.info('Word document extraction requires backend processing. Using basic extraction...');
                        resolve('Word document content will be extracted by the backend service.');
                    } else {
            ...
            <DialogContent className="max-w-[95vw] sm:max-w-[90vw] lg:max-w-6xl xl:max-w-7xl h-[95vh] overflow-y-auto overflow-x-hidden flex flex-col">
                ...
                <Tabs value={currentTab} onValueChange={setCurrentTab} className="flex-1 flex flex-col overflow-hidden">
                    <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 gap-1">
                        ...
                        <TabsTrigger value="legal" className="text-xs sm:text-sm">Legal & Metadata</TabsTrigger>
                    </TabsList>
                    ...
                    <ScrollArea className="flex-1 mt-4 overflow-y-auto">
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                            ...
                                            {validationErrors.name && (
                                                <p className="text-xs sm:text-sm text-red-500">{validationErrors.name}</p>
                                            )}
                                        </div>

                                        <div className="space-y-2">
                                            <Label htmlFor="templateId" className="text-sm sm:text-base">
                                                Template ID <span className="text-red-500">*</span>
                                            </Label>
                                            <Input
                                                id="templateId"
                                                value={formData.templateId}
                                                onChange={(e) => setFormData(prev => ({ ...prev, templateId: e.target.value.toLowerCase().replace(/\s+/g, '_') }))}
                                                placeholder="e.g., service_agreement_v1"
                                                className={validationErrors.templateId ? 'border-red-500' : ''}
                                            />
                                            {validationErrors.templateId && (
                                                <p className="text-xs sm:text-sm text-red-500">{validationErrors.templateId}</p>
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <div className="space-y-2">
                                            <Label htmlFor="locale" className="text-sm sm:text-base">Locale</Label>
                                            <Input
                                                id="locale"
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="title" className="text-sm sm:text-base">Metadata Title</Label>
                                        <Input
                                            id="title"
                        ...
                        <TabsContent value="content" className="space-y-4 sm:space-y-6 p-1">
                            <Card>
                                <CardHeader>
                                    <CardTitle className="text-base sm:text-lg">Template Content</CardTitle>
                                    <CardDescription className="text-xs sm:text-sm">
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="space-y-3">
                                        <Label className="text-sm sm:text-base">Import from File (Optional)</Label>
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Supported formats: PDF, DOC, DOCX, TXT. Content will be automatically extracted.
                                        </p>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Textarea
                                            ...
                                            rows={15}
                                            className={`font-mono text-xs sm:text-sm ${validationErrors.body ? 'border-red-500' : ''}`}
                                        />
                                        {validationErrors.body && (
                                            <p className="text-xs sm:text-sm text-red-500">{validationErrors.body}</p>
                                        )}
                                        <p className="text-xs text-muted-foreground">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="htmlBody" className="text-sm sm:text-base">HTML Body (Optional)</Label>
                                        <Textarea
                                            id="htmlBody"
                                            value={formData.content.htmlBody || ''}
                                            onChange={(e) => setFormData(prev => ({
                                                ...prev,
                                                content: { ...prev.content, htmlBody: e.target.value }
                                            }))}
                        ...
                        {/* Variables Tab */}
                        <TabsContent value="variables" className="space-y-4 sm:space-y-6 p-1">
                            <Card>
                                <CardHeader>
                                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                        <div>
                                            <CardTitle className="text-base sm:text-lg">Template Variables</CardTitle>
                                            <CardDescription className="text-xs sm:text-sm">
                                                Define dynamic fields that will be filled in when creating contracts
                                            </CardDescription>
                                        </div>
                                        <Button onClick={addVariable} size="sm" className="w-full sm:w-auto">
                                ...
                                <CardContent className="space-y-4">
                                    {variables.length === 0 ? (
                                        <div className="text-center py-8 text-muted-foreground">
                                            ...
                                            <p className="text-sm sm:text-base">No variables defined yet</p>
                                            <p className="text-xs sm:text-sm">Add variables to make your template dynamic</p>
                                        </div>
                                    ) : (
                                                    ...
                                                    <CardContent className="pt-4">
                                                        <div className="space-y-4">
                                                            <div className="flex items-center justify-between">
                                                                <Badge variant="outline" className="text-xs">Variable {index + 1}</Badge>
                                                                <Button
                                                                    type="button"
                                                                    variant="ghost"
                                                                    size="sm"
                                                            ...
                                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                                ...
                                                                <div className="space-y-1">
                                                                    <Label className="text-xs sm:text-sm">Group (Optional)</Label>
                                                                    <Input
                                                                        value={variable.group || ''}
                                                                        onChange={(e) => updateVariable(index, 'group', e.target.value)}
                                                            ...
                                                            <div className="flex items-center gap-4">
                                                                <div className="flex items-center space-x-2">
                                                                    <input
                                                                        ...
                                                                        className="rounded"
                                                                    />
                                                                    <Label htmlFor={`required_${index}`} className="text-xs sm:text-sm cursor-pointer">
                                                                        Required field
                                                                    </Label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            {variable.type === 'select' && (
                                                                <div className="space-y-1">
                                                                    <Label className="text-xs sm:text-sm">Options (comma-separated)</Label>
                                                                    <Input
                                                                        value={variable.options?.join(', ') || ''}
                                                                        onChange={(e) => updateVariable(index, 'options', e.target.value.split(',').map((s: string) => s.trim()))}
                        ...
                        <TabsContent value="legal" className="space-y-4 sm:space-y-6 p-1">
                            <Card>
                                <CardHeader>
                                    <CardTitle className="text-base sm:text-lg">Legal Requirements</CardTitle>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                            <Label className="text-sm sm:text-base">Signature Type</Label>
                                            <Select
                                        ...
                                        <div className="space-y-2">
                                            <Label htmlFor="retentionPeriod" className="text-sm sm:text-base">
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) => setFormData(prev => ({
                                                    ...prev,
                                                    legal: { ...prev.legal, retentionPeriod: parseInt(e.target.value) || undefined }
                                                }))}
                                                placeholder="e.g., 7"
                                            />
                                        </div>
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-center space-x-2">
                                            <input
                                                ...
                                                onChange={(e) => setFormData(prev => ({
                                                    ...prev,
                                                    legal: { ...prev.legal, requiresSignature: e.target.checked }
                                                }))}
                                                className="rounded"
                                            />
                                            <Label htmlFor="requiresSignature" className="text-sm sm:text-base cursor-pointer">
                                                Requires Signature
                                            </Label>
                                        </div>
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <input
                                                ...
                                                onChange={(e) => setFormData(prev => ({
                                                    ...prev,
                                                    legal: { ...prev.legal, witnessRequired: e.target.checked }
                                                }))}
                                                className="rounded"
                                            />
                                            <Label htmlFor="witnessRequired" className="text-sm sm:text-base cursor-pointer">
                                                Witness Required
                                            </Label>
                                        </div>
                                        ...
                                        <div className="flex items-center space-x-2">
                                            <input
                                                ...
                                                onChange={(e) => setFormData(prev => ({
                                                    ...prev,
                                                    legal: { ...prev.legal, notarizationRequired: e.target.checked }
                                                }))}
                                                className="rounded"
                                            />
                                            <Label htmlFor="notarizationRequired" className="text-sm sm:text-base cursor-pointer">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="complianceNotes" className="text-sm sm:text-base">
                                            Compliance Notes
                                        </Label>
                                        <Textarea
                                            id="complianceNotes"
                                            ...
                                            onChange={(e) => setFormData(prev => ({
                                                ...prev,
                                                legal: { ...prev.legal, complianceNotes: e.target.value }
                                            }))}
                            ...
                            <Card>
                                <CardHeader>
                                    <CardTitle className="text-base sm:text-lg">Additional Metadata</CardTitle>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                        ...
                                        <div className="space-y-2">
                                            <Label htmlFor="jurisdiction" className="text-sm sm:text-base">
                                                Jurisdiction
                                            </Label>
                                            <Input
                                                id="jurisdiction"
                                                ...
                                                onChange={(e) => setFormData(prev => ({
                                                    ...prev,
                                                    metadata: { ...prev.metadata, jurisdiction: e.target.value }
                                                }))}
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="applicableLaw" className="text-sm sm:text-base">
                                            Applicable Law
                                        </Label>
                                        <Input
                                            id="applicableLaw"
                                            ...
                                            onChange={(e) => setFormData(prev => ({
                                                ...prev,
                                                metadata: { ...prev.metadata, applicableLaw: e.target.value }
                                            }))}
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex flex-wrap gap-2 mb-2">
                                            {keywords.map((keyword) => (
                                                <Badge key={keyword} variant="outline" className="text-xs sm:text-sm">
                                                    {keyword}
                                                    <Button
                                                        type="button"
                                                        variant="ghost"
