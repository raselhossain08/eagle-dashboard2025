      ...
      <DialogContent className="max-w-2xl">
        ...
        <ScrollArea className="max-h-[80vh]">
          <div className="space-y-6 pr-4">
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/50">
                  ...
                  <div className="flex-1">
                    <p className="font-medium capitalize">
                      {(transaction as any).paymentMethod.type}
                    </p>
            ...
            {/* Refund History */}
            {(transaction as any).refunds &&
              (transaction as any).refunds.length > 0 && (
                <div>
                  <h3 className="text-lg font-semibold mb-3">Refund History</h3>
                  <div className="space-y-3">
                    {(transaction as any).refunds.map(
            ...
            {(transaction as any).refunds &&
              (transaction as any).refunds.length > 0 && <Separator />}
            {transaction.billing && (
              <div>
