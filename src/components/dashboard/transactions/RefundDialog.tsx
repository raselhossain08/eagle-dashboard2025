...
import {
  Transaction,
  transactionService,
} from "@/lib/services/transactio.service";
...
export function RefundDialog({
  ...
  const maxAmountInDollars =
    (transaction.amount.gross - (transaction.amount.refunded || 0)) / 100;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (refundAmount > maxAmountInDollars) {
      setError(`Refund amount cannot exceed ${maxAmountInDollars.toFixed(2)}`);
      return;
    }
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Maximum refundable: ${maxAmountInDollars.toFixed(2)}{" "}
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {parseFloat(amount || "0").toFixed(2)} {transaction.currency}?
              <br />
              <br />
