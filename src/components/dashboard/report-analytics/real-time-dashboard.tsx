    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {data.timeWindow}-minute window •{" "}
            {data.activeUsers.change > 0 ? "+" : ""}
            {data.activeUsers.change}% change
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-end justify-between">
            ...
            <div
              className={`flex items-center ${
                data.activeUsers.changeDirection === "up"
                  ? "text-green-600"
                  : "text-red-600"
              }`}
            >
              <TrendingUp
                className={`w-5 h-5 mr-1 ${
                  data.activeUsers.changeDirection === "down"
                    ? "rotate-180"
                    : ""
                }`}
              />
