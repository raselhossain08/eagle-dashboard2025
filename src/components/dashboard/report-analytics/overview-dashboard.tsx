                        ...
                        <Table>
                            ...
                            <TableBody>
                                {data.topPages.data.map((item: any, index: number) => (
                                    <TableRow key={index}>
                                        <TableCell className="font-medium">{item.page.title}</TableCell>
                ...
                <Card>
                    ...
                    <CardContent>
                        <Table>
                            ...
                            <TableBody>
                                {data.recentEvents.data.slice(0, 5).map((event: any, index: number) => (
                                    <TableRow key={index}>
                    ...
                    <CardContent>
                        <div className="space-y-2">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span>{(data.stats.averagePageViewsPerSession || 0).toFixed(2)}</span>
                            </div>
                        </div>
                    </CardContent>
                </Card>
