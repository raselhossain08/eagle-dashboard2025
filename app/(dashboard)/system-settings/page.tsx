...
export default function SystemSettingsManagement() {
  ...
  const [selectedPolicyUrl, setSelectedPolicyUrl] = useState<PolicyUrl | null>(
    null
  );
  ...
  const handleUpdateFeatureFlag = async () => {
    ...
    try {
      await systemSettingsService.updateFeatureFlag(
  ...
  const handleToggleMaintenanceMode = async () => {
    try {
      ...
      toast.success(
        `Maintenance mode ${maintenanceForm.enabled ? "enabled" : "disabled"}`
      );
      ...
      {analytics && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {analytics?.featureFlags?.total || 0}
              </div>
              <p className="text-xs text-muted-foreground">
                {analytics?.featureFlags?.enabled || 0} enabled
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {analytics?.legalTexts?.total || 0}
              </div>
              <p className="text-xs text-muted-foreground">
                {analytics?.legalTexts?.active || 0} active
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {analytics?.policyUrls?.total || 0}
              </div>
              <p className="text-xs text-muted-foreground">
                {analytics?.policyUrls?.public || 0} public
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {analytics?.configurations?.total || 0}
              </div>
              <p className="text-xs text-muted-foreground">
                {analytics?.configurations?.secret || 0} secret
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Dialog
                  open={showFeatureFlagDialog}
                  onOpenChange={setShowFeatureFlagDialog}
                >
                  <DialogTrigger asChild>
                    <Button
                      onClick={() => {
                  ...
                  <DialogContent className="max-w-2xl">
                    ...
                    <div className="flex justify-end gap-2">
                      <Button
                        variant="outline"
                        onClick={() => setShowFeatureFlagDialog(false)}
                      >
                        Cancel
                      </Button>
                      <Button
                    ...
                    {settings?.featureFlags?.length === 0 ? (
                      ...
                      settings?.featureFlags?.map((flag) => (
                        <TableRow key={flag._id}>
                          ...
                          <TableCell>
                            <Badge
                              className={systemSettingsService.getEnvironmentColor(
                                flag.environment
                              )}
                            >
                              {flag.environment}
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Manage privacy policies, terms of service, and legal
                    documents
                  </CardDescription>
                </div>
                <Dialog
                  open={showLegalTextDialog}
                  onOpenChange={setShowLegalTextDialog}
                >
                  <DialogTrigger asChild>
                    <Button
                      onClick={() => {
                        setSelectedLegalText(null);
                        resetLegalTextForm();
                      }}
                    >
                      <Plus className="mr-2 h-4 w-4" />
                  ...
                  <DialogContent className="max-w-4xl">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="gdpr_notice">
                              GDPR Notice
                            </SelectItem>
                            <SelectItem value="ccpa_notice">
                              CCPA Notice
                            </SelectItem>
                            <SelectItem value="disclaimer">
                              Disclaimer
                            </SelectItem>
                            <SelectItem value="acceptable_use">
                              Acceptable Use
                            </SelectItem>
                            <SelectItem value="refund_policy">
                              Refund Policy
                            </SelectItem>
                            <SelectItem value="subscription_terms">
                              Subscription Terms
                            </SelectItem>
                          </SelectContent>
                        </Select>
                    ...
                    <div className="flex justify-end gap-2">
                      <Button
                        variant="outline"
                        onClick={() => setShowLegalTextDialog(false)}
                      >
                        Cancel
                      </Button>
                        ...
                        <TableRow key={text._id}>
                          ...
                          <TableCell>
                            <Badge variant="outline">
                              {systemSettingsService.formatLegalTextType(
                                text.type
                              )}
                            </Badge>
                          </TableCell>
                          ...
                          <TableCell>
                            <Badge
                              className={systemSettingsService.getStatusColor(
                                text.approvalStatus
                              )}
                            >
                            ...
                            <div className="flex gap-1">
                              ...
                              {text.approvalStatus === "pending_review" && (
                                <Button
                                  ...
                                  variant="outline"
                                  onClick={() =>
                                    text._id && handleApproveLegalText(text._id)
                                  }
                                >
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Dialog
                  open={showPolicyUrlDialog}
                  onOpenChange={setShowPolicyUrlDialog}
                >
                  <DialogTrigger asChild>
                    <Button
                      onClick={() => {
                        setSelectedPolicyUrl(null);
                        resetPolicyUrlForm();
                      }}
                    >
                      <Plus className="mr-2 h-4 w-4" />
                  ...
                  <DialogContent>
                    ...
                    <div className="flex justify-end gap-2">
                      <Button
                        variant="outline"
                        onClick={() => setShowPolicyUrlDialog(false)}
                      >
                        Cancel
                      </Button>
                    ...
                    {settings?.policyUrls?.length === 0 ? (
                      ...
                      settings?.policyUrls?.map((url) => (
                        <TableRow key={url._id}>
                          ...
                          <TableCell>
                            <Badge
                              className={systemSettingsService.getCategoryColor(
                                url.category
                              )}
                            >
                              {systemSettingsService.formatPolicyCategory(
                                url.category
                              )}
                            </Badge>
                          </TableCell>
