...
import { CustomerStats } from "@/components/wordpress/customers/customer-stats";
import { CustomerFilters } from "@/components/wordpress/customers/customer-filters";
import { CustomerTable } from "@/components/wordpress/customers/customer-table";
import { CustomerPagination } from "@/components/wordpress/customers/customer-pagination";
...
export default function CustomersPage() {
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      ...
      {/* Customers Table */}
      <CustomerTable customers={data.data.customers} loading={loading} />
