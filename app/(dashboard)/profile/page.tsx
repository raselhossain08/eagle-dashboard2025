...
export default function ProfilePage() {
    ...
    const accountCreatedDate = new Date(user?.createdAt || Date.now()).toLocaleDateString('en-US', {
        month: 'long',
        day: 'numeric',
        year: 'numeric'
    });
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-start md:items-center mb-8 pb-8 border-b border-gray-200 dark:border-gray-800">
                            <div className="relative group">
                                ...
                                {isEditing && !isUploadingAvatar && (
                                    <label htmlFor="avatar-upload" className="absolute bottom-0 right-0 p-2 bg-blue-600 rounded-full text-white hover:bg-blue-700 transition-colors shadow-lg cursor-pointer">
                            ...
                            <div className="flex-1 space-y-2">
                                ...
                                <div className="flex flex-wrap gap-3 text-sm">
                                    <div className="flex items-center gap-2 px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded-full">
                                        ...
                                        <span className="capitalize">{user?.adminLevel || 'User'}</span>
                                    </div>
                    ...
                    <Card className="border-2 border-gray-200/50 dark:border-gray-800/50">
                        ...
                        <CardContent className="space-y-3">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-sm font-medium capitalize">{user?.adminLevel}</span>
                            </div>
                            <div className="flex items-center justify-between">
                    ...
                    <Card className="border-2 border-gray-200/50 dark:border-gray-800/50">
                        ...
                        <CardContent className="space-y-3">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-sm font-medium text-yellow-600 dark:text-yellow-400">Not Set</span>
                            </div>
                            <div className="flex items-center justify-between">
